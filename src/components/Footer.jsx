...
const locomotiveScroll = new LocomotiveScroll();
    ...
    return (
        <div  data-scroll data-scroll-section data-scroll-speed=".1"  className='w-full h-screen bg-zinc-900 py-10 flex overflow-hidden'>
            <div className='w-1/2 flex flex-col justify-between h-full font-["Founders-Grotesk"] px-5' >
                <div className='heading'>
                    <h1 className='text-[10vw] font-semibold uppercase leading-none'>Eye -</h1>
                    <h1 className='text-[10vw] font-semibold uppercase leading-none'>Opening</h1>
                </div>
            ...
            <div className='w-1/2 px-5 flex flex-col justify-between'>
                <h1 className='text-[5vw] font-semibold uppercase leading-none'>Presentations</h1>
                <div className="dets mt-5" >
                    ...
                    {[
                        ...
                        <a className='block text-xl font-light ' key={index} href={link.url} target="_blank" rel="noopener noreferrer">
                            {link.name}
                        </a>
                    ))}
                </div>
                <h2 className='text-2xl '>© ochi design 2025. Legal Terms</h2>
            </div>
            <div className='w-1/2 px-5 flex flex-col justify-between'>
                <h1 className='text-[5vw] font-semibold uppercase leading-none'></h1>
                <div className="dets mt-32" >
                    <h1 className='mb-10'>
                        M:
                    </h1>
                    {[
                ...
                <h4 className='text-[16px]'>Website by Obys</h4>
            </div>
        </div>
    )
}
