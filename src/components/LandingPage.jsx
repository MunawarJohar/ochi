...
const LandingPage = () => {
    return (
        ...
        <div data-scroll data-scroll-section data-scroll-speed="-.3" className='w-full h-auto bg-zinc-900 pt-1 relative'>
                    ...
                    return <div className="masker">
                        <div className='w-fit flex items-center'>
                            {index === 1 && (<motion.div
                                initial={{ width: 0 }}
                                animate={{ width: "9vw" }}
                                transition={{ ease: "easeOut", duration: 0.5 }} // You can change the duration and easing function
                                className="h-[5vw] bg-cover bg-[url('https://ochi.design/wp-content/uploads/2022/04/content-image01.jpg')] bg-red-500 relative mr-5 rounded-md"
                            />)}
      ...
      <h1 className="uppercase text-9xl -leading-[4vw] tracking-tighter font-['Founders_Grotesk'] font-medium">
        eye-opening
      </h1>
    </div>
        ...
        Presentations
            ...
            <div   className='border-t-[1px] border-zinc-800 mt-32 flex justify-between items-center py-5 px-20'>
                ...
                <div className='start flex items-center gap-5'>
                    <div className='px-4 py-2 font-light text-sm border-[2px] border-zinc-700 rounded-full text-md uppercase font-light ' >start the projects </div>
